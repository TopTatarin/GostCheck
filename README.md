...
- [ ] **T-04 — провайдеры моделей.** Добавить общий интерфейс, режим
...
- [ ] **T-05 — семантические advisory-проверки.** Реализовать консультативные
  проверки по подготовленному `DocumentBundle`; они не должны блокировать
  формальный gate.
- [ ] **T-06 — локальный GPU smoke и benchmark.** Проверить Ollama и выбранную
